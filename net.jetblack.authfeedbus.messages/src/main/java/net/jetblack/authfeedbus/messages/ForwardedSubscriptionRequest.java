...
public class ForwardedSubscriptionRequest extends Message {
    ...
    public ForwardedSubscriptionRequest(String user, InetAddress address, UUID clientId, String feed, String topic, boolean isAdd) {
	...
	public String toString() {
	    return String.format(
	    		"%s, User=%s, Address=%s, ClientId=%s, Feed=%s, Topic=%s, IsAdd=%s",
	    		super.toString(),
	    		User, 
	    		Address,
	    		ClientId,
