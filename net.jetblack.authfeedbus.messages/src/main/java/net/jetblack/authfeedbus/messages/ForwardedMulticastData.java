...
public class ForwardedMulticastData extends Message {
	...
	public ForwardedMulticastData(String user, InetAddress address, String feed, String topic, boolean isImage,
			BinaryDataPacket[] data) {
	...
	public String toString() {
		return String.format("%s, User=%s, Address=%s, Feed=%s, Topic=%s, IsImage=%s, Data=%s", super.toString(), User,
				Address, Feed, Topic, IsImage, Data);
	}
