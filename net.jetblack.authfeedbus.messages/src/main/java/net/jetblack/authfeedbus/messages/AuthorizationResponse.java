...
public class AuthorizationResponse extends Message {
	...
	public AuthorizationResponse(UUID clientId, String feed, String topic, boolean isAuthorizationRequired,
			UUID[] entitlements) {
	...
	public String toString() {
		return String.format("%s, ClientId={ClientId}, Feed=%s, Topic=%s, IsAuthorizationRequired=%s, Entitlements=%s",
				super.toString(), ClientId, Feed, Topic, IsAuthorizationRequired, Entitlements);
	}
