...
public class Acceptor implements Runnable {
    ...
    public Acceptor(InetAddress address, int port, EventQueue<InteractorEventArgs> eventQueue, int writeQueueCapacity, AtomicBoolean isCancelled) {
	...
	public void run() {
		...
		try {
			listener = new InteractorListener(Address, Port, _eventQueue, _writeQueueCapacity, _isCancelled);
