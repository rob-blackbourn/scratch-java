...
public class Server implements Disposable {
    ...
    public Server(InetAddress address, int port, int writeQueueCapacity) {
        _eventQueue = new EventQueue<InteractorEventArgs>(_isCancelled, 8096);
        ...
        _acceptor = new Acceptor(address, port, _eventQueue, writeQueueCapacity, _isCancelled);
