...
public class SubscriptionManager {
    ...
    public SubscriptionManager(InteractorManager interactorManager, NotificationManager notificationManager) {
        ...
        notificationManager.addNewNotificationRequestListener(new EventListener<NotificationEventArgs>() {
			@Override
			public void onEvent(Object source, NotificationEventArgs event) {
        ...
        _publisherManager.addStalePublisherListener(new EventListener<StalePublisherEventArgs>() {

			@Override
			public void onEvent(Object source, StalePublisherEventArgs event) {
